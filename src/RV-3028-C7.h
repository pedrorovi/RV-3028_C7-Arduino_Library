...
#define EEPROMClkout_PORIE \
    3  // 0 = No interrupt, or canceled, signal on INT pin at POR. – Default value on delivery
       // 1 = An interrupt signal on INT pin at POR. Retained until the PORF flag is cleared to 0 (no automatic
       // cancellation).
...
class RV3028 {
   public:
    ...
    void setTimer(bool timer_repeat,
